        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex flex-col gap-4 mb-6">
            ...
            <button 
              ...
              className={`w-full flex items-center justify-center gap-4 py-4 px-4 border border-primary transition-all duration-300 font-sans tracking-wide text-xs uppercase ${isAuthenticating ? 'opacity-50 cursor-not-allowed bg-gray-50' : 'bg-primary text-white hover:bg-primary/90 cursor-pointer shadow-sm hover:shadow-md'}`}
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24">
                <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
