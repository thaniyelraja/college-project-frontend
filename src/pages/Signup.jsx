    ...
    try {
      ...
      try {
        ...
        if (existsRes.data === true) {
          await signOut(auth);
          setError('User already exists in DB! Please Log In instead.');
        ...
        console.warn('Backend exists check failed, assuming new user.', dbErr);
      }
      ...
      <div className="hidden md:flex md:w-1/2 relative overflow-hidden bg-primary items-center justify-center">
        ...
        <div className="relative z-10 p-16 text-white text-center">
          ...
          <p className="font-sans font-light text-base text-white/70 max-w-xs mx-auto leading-relaxed">
            Begin your journey today with our intelligent itinerary generator.
          </p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 lg:p-24 relative">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted font-sans mb-12 text-sm">
            Sign up to start planning your trips with AI.
          </p>
          ...
          <div className="mb-6">
            <button 
              ...
              className={`w-full flex items-center justify-center gap-4 py-4 px-4 border border-primary transition-all duration-300 font-sans tracking-wide text-xs uppercase ${isAuthenticating ? 'opacity-50 cursor-not-allowed bg-gray-50 text-black border-primary/20' : 'bg-primary text-white hover:bg-primary/90 cursor-pointer shadow-sm hover:shadow-md'}`}
            >
